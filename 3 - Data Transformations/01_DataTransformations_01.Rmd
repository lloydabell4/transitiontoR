...
Missing values can cause all sorts of headaches because many aggregation functions will output a missing value if a missing value in part of the input. There are two primary ways of getting around this issue.
